...
export const alertConfigSnapshot: AlertConfigSnapshot = {
  ...
  rulesFile: "/etc/cloudlens/alert-rules.yaml",
...
export const alertDashboard: AlertDashboard = {
  ...
  rules: {
    source: "/etc/cloudlens/alert-rules.yaml",
...
export const systemProcesses: SystemProcess[] = [
  ...
  },
  {
    pid: 2318,
    name: "gwf-agent",
    command: "/usr/local/bin/gwf-agent --config /etc/cloudlens/agent.yaml",
    user: "gwf",
    status: "running",
    cpu: 12.4,
    mem: 3.2,
    ...
    env: ["CLOUDLENS_ENV=prod", "CLOUDLENS_REGION=cn-north-1"],
  },
  {
    pid: 1450,
    name: "node",
